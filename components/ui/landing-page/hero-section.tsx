...
<LiveBadge/>
     ...
     <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold tracking-light mb-6 max-w-5xl"> Stay <AuroraText>Updated</AuroraText> with all the Trending information across the <AuroraText>Globe</AuroraText></h1>
